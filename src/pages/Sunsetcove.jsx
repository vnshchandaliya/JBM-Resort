...
export default function SunsetCoveSuit() {

  const images = [
    "https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/htl-imgs/202511251229434485-17e1d7c2-f9c9-47cd-bfd1-75e232ac3672.jpg?output-quality=75&downsize=*:500&crop=990:500"   
  ];
    ...
    <section
      ...
      >
       ...
       <Link to="/rooms"><p >Rooms</p></Link>
        <p>/</p>
        <p className="text-[#cfa95d]">Sunset Cove Suite</p>
        </div>
      </section>
