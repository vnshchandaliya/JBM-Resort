...
export default function RoomDeluxe() {
  ...
  const images = [
    "https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/htl-imgs/202511251229434485-218a7eb5-6475-4902-897d-18780709bf91.jpg?output-quality=75&downsize=*:500&crop=990:500",
    "https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/htl-imgs/202511251229434485-83a425d3-a8ce-47a0-b297-6cba25a42ea9.jpg?output-quality=75&downsize=*:500&crop=990:500",
    "https://r2imghtlak.mmtcdn.com/r2-mmt-htl-image/htl-imgs/202511251229434485-afe433aa-77e3-482e-a490-799755a826bd.jpg?output-quality=75&downsize=*:500&crop=990:500",
    ...
    <section
      ...
      >
       ...
       <Link to="/rooms"><p >Rooms</p></Link>
        <p>/</p>
        <p className="text-[#cfa95d]">Deluxe Room</p>
        </div>
      </section>
        ...
        <div className="lg:col-span-4 space-y-8">
          <div>
            ...
            <li className="flex items-center gap-2"><FaCheck className="text-[#5a9aa8]" /> 
             ...
             <h5 className="text-[#5a9aa8] font-medium mt-6 mb-5">Room Features</h5>
            <ul className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-3 text-gray-700">
            <li className="flex items-center gap-2"><FaCheck className="text-[#5a9aa8]" /> 
              Closet</li>
              <li className="flex items-center gap-2"><FaCheck className="text-[#5a9aa8]" />
